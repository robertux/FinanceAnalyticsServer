...
public class Transaction implements Serializable {
	...
	public Transaction(String id, BigDecimal amount, String categoryName, Date date, String title, String description, String reference, String currency, Account account, String status) {
		super();
		this.id = id;
		this.amount = amount;
	...
	public String toString() {
		return "Transaction [id=" + id + ", amount=" + amount + ", categoryName=" + categoryName + ", date=" + date + ", title=" + title + ", description=" + description + ", reference=" + reference + ", currency=" + currency + ", account=" + account + ", status=" + status + "]";
	}
}
