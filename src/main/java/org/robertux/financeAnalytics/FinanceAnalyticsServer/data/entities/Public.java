...
public class Public extends SchemaImpl {
    ...
    private static final long serialVersionUID = 685352187;
     ...
     */
    public final Account ACCOUNT = org.robertux.financeAnalytics.FinanceAnalyticsServer.data.entities.tables.Account.ACCOUNT;

    /**
     * The table <code>public.transaction</code>.
     */
    public final Transaction TRANSACTION = org.robertux.financeAnalytics.FinanceAnalyticsServer.data.entities.tables.Transaction.TRANSACTION;

    /**
     * The table <code>public.user</code>.
     */
    public final User USER = org.robertux.financeAnalytics.FinanceAnalyticsServer.data.entities.tables.User.USER;
